...
@builtin
def arrive(mbarrier, *, count=1, pred=True, per_warp=False, _semantic=None):
    """
    ...
    pred = _semantic.to_tensor(pred)
    _semantic.builder.create_mbarrier_arrive(mbarrier.handle, count, pred.handle, per_warp)
