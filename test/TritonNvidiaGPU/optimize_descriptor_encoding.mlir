...
#desired_nvmma_0 = #ttg.nvmma_shared<{swizzlingByteWidth = 0, transposed = false, elementBitWidth = 8, rank = 5}>
...
tt.func public @descriptor_arg_from_desired_encoding(%b_desc: !tt.tensordesc<1x1x256x8x16xf8E4M3FN>) {
  // CHECK: %arg0: !tt.tensordesc<1x1x256x8x16xf8E4M3FN, #[[NVMMA_0]]>
  // CHECK: %[[LOAD:.*]] = tt.descriptor_load %arg0{{.*}}tt.desired_encoding = #[[NVMMA_0]]
  ...
  %c0 = arith.constant 0 : i32
  %b = tt.descriptor_load %b_desc[%c0, %c0, %c0, %c0, %c0] {tt.desired_encoding = #desired_nvmma_0} : !tt.tensordesc<1x1x256x8x16xf8E4M3FN> -> tensor<1x1x256x8x16xf8E4M3FN, #blocked2>
