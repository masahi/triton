    ...
    partition0  num_warps(4) {
      ...
      scf.for %i = %lb to %ub step %c1_i32 : i32{
        ...
        scf.if %cond {
          ...
          "sttm"(%2#0, %2#1) : (!ttg.memdesc<64x16xf16, #shared0, #tmem>, !ttg.memdesc<16x32xf16, #shared0, #smem>) -> ()
      ...
      "sttm"(%1#0, %1#1) : (!ttg.memdesc<64x16xf16, #shared0, #tmem>, !ttg.memdesc<16x32xf16, #shared0, #smem>) -> ()
    ...
    partition1 num_warps(8) {
      ...
      scf.for %i = %lb to %ub step %c1_i32 : i32{
        ...
        scf.if %cond {
          ...
          "ldtm"(%3#0, %3#1) : (!ttg.memdesc<64x16xf16, #shared0, #tmem>, !ttg.memdesc<16x32xf16, #shared0, #smem>) -> ()
      ...
      "lddtm"(%2#0, %2#1) : (!ttg.memdesc<64x16xf16, #shared0, #tmem>, !ttg.memdesc<16x32xf16, #shared0, #smem>) -> ()
      nvws.aref.get.exit %aref1[%c0_i32] [#nvws.async_op<none>] : !nvws.aref<[!ttg.memdesc<3x64x16xf16, #shared0, #tmem>, !ttg.memdesc<3x16x32xf16, #shared0, #smem>]>
      nvws.warp_group.return
    }
    tt.return
